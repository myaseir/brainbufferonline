...
<div className="sr-only">
  ...
  <a 
    ...
    href="https://github.com/myaseir/brainbufferofficial/releases/download/v5.0.0/BrainBuffer.apk" 
      ...
      <footer className="py-12 md:py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[10px] md:text-xs text-slate-500 leading-relaxed max-w-xl mx-auto italic">
            ...
            <span className="text-slate-900 font-bold ml-1">Glacia Labs</span>, 
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 flex flex-wrap justify-center gap-4 md:gap-8">
            <span className="text-[8px] md:text-[9px] font-black uppercase tracking-widest text-slate-300">© 2026 Glacia Labs</span>
